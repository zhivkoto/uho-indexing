 ...
 * Uho — IDL Parser
 *
 * IDL Abstraction Layer: parses Anchor, Shank, and Codama IDL formats into a
 * unified ParsedIDL representation. Handles type mapping from IDL types to
 * PostgreSQL column types, camelCase→snake_case conversion, and discriminator
 * normalization.
 *
 * Supported formats:
